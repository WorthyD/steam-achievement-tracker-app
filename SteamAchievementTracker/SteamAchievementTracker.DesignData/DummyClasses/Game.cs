...
namespace SteamAchievementTracker.DesignData.DummyClasses
{
    public class Game
    {
        public static IGame GetRandomGame()
        {
            var rnd = new Random();
            return GetRandomGame("test", rnd);
        }

        public static IGame GetRandomGame(string name, Random rnd)
        {
